...
describe('Place order as Guest user using credit Card', () => {
	...
	it('Verify the PDP page and addto bag', () => {
		const pdpsize = $(
			'//*[@id="sizeSelector"]//li//a[@data-sku-code ="800090828511"]'
		)
	...
	it('Verify the order details', () => {
		...
		// const orderthanks = $(
		// 	'body > div.js-device-info > main > div.account-section > div > div:nth-child(1) > div > div.checkout-success__body > div.checkout-success__body__headline.checkout-confirmation-top-banner > div > span:nth-child(3)'
		// )
		// ordertext = orderthanks.getText()
		// console.log(ordertext)

		// const succsfullorder = $(
		// 	'body > div.js-device-info > main > div.account-section > div > div:nth-child(1) > div > div.checkout-success__body > div.container.checkout-container > h3'
		// )

		// order = succsfullorder.getText()
